  ...
  render () {
    ...
    return (
      <div style={{ marginTop: '10px', overflow: 'hidden' }}>
        ...
        <div style={{ float: 'left', marginRight: '18px'}}><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' onClick={this.handleFavouriteClick} activeStyle={{ color: '#fad232' }} /></div>
